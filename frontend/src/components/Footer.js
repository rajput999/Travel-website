...
const Footer = () => {
  return (
    <footer className="bg-gray-300 h-auto flex flex-col md:flex-row justify-evenly items-start md:items-center p-5 md:pt-10 md:h-60">
      {/* Logo and Social Links Section */}
      <div className="flex flex-col items-start w-full md:w-auto mb-4 md:mb-0">
        <div className="flex items-center mb-4">
          <div className="h-10 mr-3">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="h-full">
              <path d="M135.2 117.4L109.1 192H402.9l-26.1-74.6C372.3 104.6 360.2 96 346.6 96H165.4c-13.6 0-25.7 8.6-30.2 21.4zM39.6 196.8L74.8 96.3C88.3 57.8 124.6 32 165.4 32H346.6c40.8 0 77.1 25.8 90.6 64.3l35.2 100.5c23.2 9.6 39.6 32.5 39.6 59.2V400v48c0 17.7-14.3 32-32 32H448c-17.7 0-32-14.3-32-32V400H96v48c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32V400 256c0-26.7 16.4-49.6 39.6-59.2zM128 288a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm288 32a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"/>
            </svg>
          </div>
          <div className="text-lg font-bold">Travel</div>
        </div>
        <div className="flex space-x-4">
          <div className="h-8">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="h-full fill-orange-600">
              <path d="M512 256C512 114.6 397.4 0 256 0S0 114.6 0 256C0 376 82.7 476.8 194.2 504.5V334.2H141.4V256h52.8V222.3c0-87.1 39.4-127.5 125-127.5c16.2 0 44.2 3.2 55.7 6.4V172c-6-.6-16.5-1-29.6-1c-42 0-58.2 15.9-58.2 57.2V256h83.6l-14.4 78.2H287V510.1C413.8 494.8 512 386.9 512 256h0z"/>
            </svg>
          </div>
          <div className="h-8">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-full fill-orange-600">
